...
This is a template for creating a .NET Web API project. It includes the necessary files and structure to get started quickly with building a Web Minimal API using .NET.
...
The package is available on [NuGet](), to install it use the following command in your terminal:
